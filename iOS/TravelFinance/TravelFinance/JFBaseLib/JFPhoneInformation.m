...
@implementation JFPhoneInformation

+ (instancetype)sharedPhoneInformation {
    static JFPhoneInformation *phoneInformation = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        phoneInformation = [[JFPhoneInformation alloc] init];
    });
