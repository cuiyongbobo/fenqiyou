...
#define CircleViewBackgroundColor rgba(66,170,229,1)

/**
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(241,241,241,1)
//#define CircleStateNormalOutsideColor rgba(13,52,89,1)
/**
 *  选中状态下外空心圆颜色
 */
//#define CircleStateSelectedOutsideColor rgba(34,178,246,1)
#define CircleStateSelectedOutsideColor rgba(13,52,89,1)
...
#define CircleStateSelectedInsideColor rgba(13,52,89,1)
...
#define CircleStateSelectedTrangleColor rgba(13,52,89,1)
...
#define CircleConnectLineNormalColor rgba(13,52,89,1)
